...
- ~~[Twitter](https://twitter.com/AdamPann) not used as often as Instagram but I do use it to tweet at software engineers that I think are cool.~~ (I haven't used this in years. Maybe I'll try again someday but probably not... Maybe bluesky?)

# **How**

This site is hosted using [Github pages](https://pages.github.com/) using ~~[Jekyll](https://jekyllrb.com/)~~ (Now using [Quartz](https://quartz.jzhao.xyz/))
